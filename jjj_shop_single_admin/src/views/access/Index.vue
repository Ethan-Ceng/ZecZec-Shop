				...
				<div>
					<el-table size="small" :data="tableData" style="width: 100%;margin-bottom: 20px;"
						...
						<el-table-column prop="name" label="操作" width="250">
							<template #default="scope">
								<el-button @click="addClick(scope.row,'copy')" type="primary" link
									v-if="scope.row.path!='/plus'">一键复制</el-button>
								<el-button @click="addClick(scope.row,'child')" type="primary" link
									size="small">添加子菜单</el-button>
								<el-button @click="editClick(scope.row)" type="primary" link size="small">编辑</el-button>
								<el-button @click="deleteClick(scope.row)" type="primary" link
