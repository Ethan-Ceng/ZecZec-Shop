...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'fontfamily':'字型', 'fontsize':'字號', 'paragraph':'段落格式', 'image':'圖片', 'insertimage':'多圖上傳','edittable':'表格屬性','edittd':'單元格屬性', 'link':'超連結',
        'emotion':'表情', 'spechars':'特殊字元', 'searchreplace':'查詢替換', 'map':'Baidu地圖', 'gmap':'Google地圖',
        'insertvideo':'影片', 'help':'幫助', 'justifyleft':'居左對齊', 'justifyright':'居右對齊', 'justifycenter':'居中對齊',
    ...
    'insertimage':{
        'static':{
            ...
            'searchType':{'title':"圖片型別", 'options':["新聞", "桌布", "表情", "頭像"]}, //select的option
