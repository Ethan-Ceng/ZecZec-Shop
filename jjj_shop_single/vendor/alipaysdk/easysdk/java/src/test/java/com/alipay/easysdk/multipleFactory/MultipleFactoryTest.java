...
public class MultipleFactoryTest {
    ...
    public void testImageUpload() throws Exception {
        ...
        AlipayOfflineMaterialImageUploadResponse response = factory.Image().upload("測試圖片",
    ...
    public void testCreateImageTextContent() throws Exception {
        ...
        AlipayOpenPublicMessageContentCreateResponse response = factory.OpenLife().createImageTextContent("標題",
