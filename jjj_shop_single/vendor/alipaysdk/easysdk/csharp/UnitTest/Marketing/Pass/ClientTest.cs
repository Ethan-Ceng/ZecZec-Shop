...
namespace UnitTest.Marketing.Pass
{
    public class ClientTest
    {
        ...
        public void TestAddInstance()
        {
            ...
            Assert.AreEqual(response.SubMsg, "該AppId不支援");
            Assert.NotNull(response.HttpBody);
            Assert.False(response.Success);
            Assert.True(response.Result.Contains("該AppId不支援"));
        }
        ...
        private string GetTplContent()
        {
            return "{\"logo\":\"http://img01.taobaocdn.com/top/i1/LB1NDJuQpXXXXbYXFXXXXXXXXXX\",\"strip\":null,\"icon\":null,"
                    ...
                    + "\"einfo\":{\"logoText\":\"test\",\"headFields\":[{\"key\":\"test\",\"label\":\"測試\",\"value\":\"\","
                    + "\"type\":\"text\"}],\"primaryFields\":[{\"key\":\"from\",\"label\":\"測試\",\"value\":\"\",\"type\":\"text\"},"
                    + "{\"key\":\"to\",\"label\":\"測試\",\"value\":\"\",\"type\":\"text\"}],\"secondaryFields\":[{\"key\":\"fltNo\","
                    + "\"label\":\"航班號\",\"value\":\"CA123\",\"type\":\"text\"}],\"auxiliaryFields\":[{\"key\":\"test\","
                    + "\"label\":\"測試\",\"value\":\"\",\"type\":\"text\"}],\"backFields\":[]},\"locations\":[]},"
                    + "\"merchant\":{\"mname\":\"鍾雨\",\"mtel\":\"\",\"minfo\":\"\"},\"platform\":{\"channelID\":\"2088201564809153\","
                    ...
                    + "\"android_download\":\"\",\"ios_download\":\"\"},\"label\":\"測試\",\"message\":\"\"},"
