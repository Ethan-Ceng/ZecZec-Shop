...
class AntCertificationUtil
{
    ...
    /**
     * 驗證支付寶公鑰證書是否可信
     * @param $alipayCert 支付寶公鑰證書
     * @param $rootCert   支付寶根證書
     * @return bool       驗證證書是否可信
     */
    ...
    /**
     * 驗證證書鏈是否是信任證書庫中證書籤發的
     * @param $alipayCerts array 目標驗證證書列表
     * @param $rootCerts   array 可信根證書列表
     * @return bool
     */
    ...
    /**
     * 向上構造證書鏈
     * @param $subjectMap array 主題和證書的對映
     * @param $certChain  array 證書鏈
