...
class ClientTest extends TestCase
{
    ...
    public function testAddInstance()
    {
        ...
        $this->assertEquals('該AppId不支援', $result->subMsg);
    }
    ...
    private function getTplContent()
    {
		...
		"evoucherInfo": {
			...
			"einfo": {
				"logoText": "test",
				"headFields": [{"key": "test","label": "測試","value": "","type": "text"}],
				"primaryFields": [{"key": "from","label": "測試","value": "","type": "text"},{"key": "to","label": "測試","value": "","type": "text"}],
				"secondaryFields": [{"key": "fltNo","label": "航班號","value": "CA123","type": "text"}],
				"auxiliaryFields": [{"key": "test","label": "測試","value": "","type": "text"}],
				"backFields": []
			},
			"locations": []
		},
		...
		"appInfo": {"app": {"android_appid": "","ios_appid": "","android_launch": "","ios_launch": "","android_download": "","ios_download": ""},"label": "測試","message": ""},
		"source": "alipassprod",
		"alipayVerify": ["qrcode"]}}';
    }
}