...
服務端的作用呢，在整個微信開發中主要是負責 **[接收使用者傳送過來的訊息](https://developers.weixin.qq.com/doc/offiaccount/Message_Management/Receiving_standard_messages.html)**，還有 **[使用者觸發的一系列事件](https://developers.weixin.qq.com/doc/offiaccount/Message_Management/Receiving_event_pushes.html)**。
