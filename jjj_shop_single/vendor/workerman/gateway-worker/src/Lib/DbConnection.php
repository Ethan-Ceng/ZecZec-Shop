...
/**
 * 資料庫連線類，依賴 PDO_MYSQL 擴充套件
 * 在 https://github.com/auraphp/Aura.SqlQuery 的基礎上修改而成
 */
class DbConnection
{
    /**
    ...
    /**
     * sql 的型別 SELECT INSERT DELETE UPDATE
     *
     * @var string
     */
    protected $type = '';
    ...
    // ---------- insert --------------
    /**
     * 設定 `table.column` 與 last-insert-id 的對映
     *
