<template>
	...
	<el-dialog title="超链接设置" append-to-body v-model:visible="dialogVisible" @close="dialogFormVisible"
		...
		<div slot="footer" class="dialog-footer d-b-c">
			...
			<div class="setlink-footer-btn">
				...
				<el-button size="small" type="warning" @click="resetting">清空</el-button>
