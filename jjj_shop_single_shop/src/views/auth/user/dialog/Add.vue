<template>
  ...
  <el-dialog title="添加管理员" width="600px" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false" :close-on-press-escape="false">
    <!--form表单-->
    <el-form size="small" ref="form" :model="form" :rules="formRules" :label-width="formLabelWidth">
      ...
      <el-form-item label="所属角色" prop="role_id">
        <el-select v-model="form.role_id" :multiple="true" style="width:440px;">
