    ...
    <div class="product-content">
      <el-form ref="form" :model="form" :rules="formRules" label-width="150px">
        ...
        <el-form-item label="" v-if="form.is_coupon">
          <el-button type="primary" @click="addCoupon()" class="mb16">添加</el-button>
        ...
        <el-form-item label="" v-if="form.is_product">
          <el-button type="primary" @click="addProduct()"  class="mb16">添加</el-button>
        ...
        <el-form-item label="积分数量" v-if="form.is_point">
          <el-input type="number" min="1" v-model="form.point" class="max-w460">
            <template #append>
              积分
            </template>
          </el-input>
        ...
        <el-form-item label="购买金额" prop="money" :rules="[{ required: true, message: ' ' }]">
          <el-input type="number" min="1" v-model="form.money" class="max-w460">
            <template #append>
              元
            </template>
          </el-input>
        ...
        <el-form-item label="发放数量" prop="total_num" :rules="[{ required: true, message: ' ' }]">
          <el-input min="1" type="number" v-model="form.total_num" placeholder="请输入发放数量" class="max-w460"></el-input>
        </el-form-item>
        <el-form-item label="二维码" prop="code_type" :rules="[{ required: true, message: ' ' }]">
          <el-radio-group v-model="form.code_type">
            <el-radio :label="10">一批一码</el-radio>
            <el-radio :label="20">一物一码</el-radio>
          </el-radio-group>
          <div class="gray9">一批一码：这个活动使用一个二维码；一物一码：生成的每个二维码不一样；</div>
        </el-form-item>
      </el-form>
      <!--提交-->
