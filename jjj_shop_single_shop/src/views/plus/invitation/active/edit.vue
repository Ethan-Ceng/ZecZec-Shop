		...
		<div class="product-content">
			<el-form ref="form" :model="form" :rules="formRules" label-width="150px">
				...
				<el-form-item label="背景图" prop="image_id">
					...
					<div class="ww100">建议尺寸750*1340</div>
				</el-form-item>
				...
				<el-form-item label="分享图" prop="share_image_id">
					...
					<div class="ww100">建议尺寸800*800</div>
				</el-form-item>
				<el-form-item label="活动日期" prop="value1" :rules="[{required: true,message: ' '}]">
					<div class="block">
						<span class="demonstration"></span>
						<el-date-picker v-model="form.value1" type="datetimerange" value-format="YYYY-MM-DD"
				...
				<div v-for="(item, reward_index) in rewardData" :key="reward_index" class="mt16">
					<el-row align="middle" justify="space-between" class="ww100">
						<div>
							<span style="font-weight: 900;">奖项{{reward_index+1}}:</span>
							<span>每邀请</span>
							<el-input type="number" v-model="item.invitation_num" size="small" style="width: 100px;"
								class="ml4"></el-input>
							<span class="ml4">人获得礼品</span>
							<el-checkbox v-model="item.is_balance" class="pl16">余额</el-checkbox>
							<el-input type="number" v-model="item.balance" size="small"
								style="width: 100px;"></el-input>
							<el-checkbox v-model="item.is_point" class="pl16">积分</el-checkbox>
							<el-input type="number" v-model="item.point" size="small" style="width: 100px;"></el-input>
							<el-checkbox v-model="item.is_coupon" class="pl16">优惠券</el-checkbox>
							<el-input type="text" v-model="item.coupon_name" size="small" disabled="true"
								style="width: 200px;margin-left: 6px;"></el-input>
							<el-button type="primary" size="small" class="ml4"
								@click="addCoupon(reward_index)">选择优惠券</el-button>
						</div>
