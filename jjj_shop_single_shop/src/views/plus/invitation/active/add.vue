      ...
      <el-form ref="form" :model="form" :rules="formRules" label-width="150px">
        ...
        <el-form-item label="活动日期" prop="value1" :rules="[{required: true,message: ' '}]">
          <div class="block">
            ...
            <el-date-picker v-model="form.value1" type="datetimerange" value-format="YYYY-MM-DD" range-separator="至"
        ...
        <div v-for="(item, reward_index) in rewardData" :key="reward_index" class="mt16">
          <div>
            ...
            <span>每邀请&nbsp;&nbsp;</span>
            <el-input type="number" v-model="item.invitation_num" size="small" style="width: 100px;"></el-input>
            <span>&nbsp;&nbsp;人获得礼品</span>
            <el-checkbox v-model="item.is_balance" class="pl16">余额</el-checkbox>
            <el-input type="number" v-model="item.balance" size="small" style="width: 100px;"></el-input>
            ...
            <el-input type="text" v-model="item.coupon_name" disabled="true" size="small" style="width: 200px;margin-right: 6px;margin-left: 6px;"></el-input>
            <el-button type="primary" size="small" @click="addCoupon(reward_index)">选择优惠券</el-button>
