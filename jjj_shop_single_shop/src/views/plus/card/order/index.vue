    ...
    <div class="common-seach-wrap">
      <el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
        ...
        <el-form-item label="发货状态">
          <el-select size="small" v-model="searchForm.delivery_status" placeholder="请选择">
    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-tabs v-model="activeName" @tab-change="handleClick">
          ...
          <el-tab-pane :label="'待发货(' + order_count.wait + ')'" name="wait"></el-tab-pane>
        </el-tabs>
        <el-table size="small" :data="tableData.data" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="card.card_title" label="所属卡券"></el-table-column>
          <el-table-column prop="code.code_no" label="提货码"></el-table-column>
          <el-table-column prop="product_name" label="提货商品"></el-table-column>
          <el-table-column prop="name" label="提货人"></el-table-column>
          <el-table-column prop="mobile" label="提货电话"></el-table-column>
          <el-table-column prop="delivery_status" label="发货状态">
            <template #default="scope">
              <span class="gray" v-if="scope.row.delivery_status == 0">待发货</span>
              <span class="green" v-if="scope.row.delivery_status == 1">已发货</span>
            </template>
          </el-table-column>
          <el-table-column prop="create_time" label="提货时间"></el-table-column>
          <el-table-column fixed="right" label="操作" width="110">
            <template #default="scope">
              <el-button @click="addClick(scope.row)" type="text" size="small" v-auth="'/order/order/detail'">详情
              </el-button>
              <el-button v-if="scope.row.delivery_status == 0" @click="addClick(scope.row)" type="text" size="small"
