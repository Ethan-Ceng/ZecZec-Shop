<template>
	...
	<div v-loading="loading">
		...
		<el-form size="small" ref="form" :model="form" label-width="200px">
			...
			<template v-if="activeName=='2'">
				...
				<el-form-item v-if="form.apply_range==20">
					...
					<el-table v-if="product_list.length>0" :data="product_list" max-height="400" border
						style="width: 100%">
				...
				<el-form-item label="" v-if="form.apply_range==30">
					...
					<div>
						<template v-if="category_list.first.length>0">
							<div v-for="(item,index) in category_list.first" :key="item.category_id" class="mr10 mb10"
						...
						<template v-if="category_list.second.length>0">
							<div v-for="(item,index) in category_list.second" :key="item.category_id" class=" mr10 mb10"
								style="display:inline-block;">
		...
		<!--选择商品-->
		<Product :isproduct="is_product" :excludeIds="exclude_ids" :islist="true" @closeDialog="closeProductFunc">
		</Product>
