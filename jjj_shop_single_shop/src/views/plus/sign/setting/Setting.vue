			...
			<div v-show="form.is_open" class="mt16">
				...
				<el-form-item label="递增奖励">
					...
					<div v-if="form.is_increase" class="max-w460 border p-0-20 pt16 mt10">
						<el-form-item label="第二天起递增奖励" label-width="120px" prop="increase_reward">
							<div class="d-s-c">
								<div class="flex-1">
									<el-input v-model="form.increase_reward" placeholder="请输入第二天起递增积分数" min="0"
						...
						<el-form-item label="第" label-width="120px" prop="no_increase">
							<div class="d-s-c">
								<div class="flex-1">
									<el-input v-model="form.no_increase" placeholder="请输入第几天不再递增" min="0"
										type="number"></el-input>
								</div>
				...
				<el-form-item label="额外奖励">
					<div class="reward-list max-w460">
						<div class="reward-item pr border" v-for="(item, reward_index) in form.reward_data"
							:key="reward_index">
							<el-button class="delete-reward" @click="deleteRewardClick(reward_index)" type="danger"
								size="small" icon="Close" circle></el-button>
							<el-form-item label="连续签到" :prop="'reward_data.' + reward_index + '.day'"
								:rules="rules.day">
								<div class="d-s-c">
									<div class="flex-1">
								...
								<div class="d-s-c">
									...
									<div v-if="item.is_point">
										<el-form-item label="送" label-width="40px"
											:prop="'reward_data.' + reward_index + '.point'" :rules="rules.point"
											style="margin-bottom: 0">
											<div class="d-s-c">
												<div class="flex-1">
													<el-input v-model="item.point" placeholder="请输入连续签到天数的积分"
														type="number" min="0"></el-input>
												</div>
					...
					<el-col>
						<el-button size="small" icon="Plus" @click="addReward">添加</el-button>
					</el-col>
				</el-form-item>
				<!--规则-->
				...
				<el-form-item label="规则说明：">
					<div class="edit_container">
						<Uediter :text="ueditor.text" :config="ueditor.config" ref="ue"
