  ...
  <div class="test-wrap mt30">
    <el-form size="small" ref="form" :model="form" label-width="200px">
      <el-form-item label="分销中心首页">
        ...
        <div v-if="form.index != ''" class="img"><img :src="form.index" width="750" height="348" /></div>
      ...
      <el-form-item label="申请提现页">
        ...
        <div v-if="form.cash_apply != ''" class="img"><img :src="form.cash_apply" width="750" height="348" /></div>
        <div class="tips">尺寸：宽750像素 高度348像素</div>
      </el-form-item>
      <!--提交-->
