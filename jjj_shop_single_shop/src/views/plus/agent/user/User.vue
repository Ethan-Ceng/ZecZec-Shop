	...
	<div class="user">
		<div class="common-seach-wrap">
			<el-form size="small" :inline="true" :model="formInline" class="demo-form-inline">
				<el-form-item label=""><el-input v-model="formInline.nick_name"
				...
				<el-form-item>
					<el-button size="small" type="primary" icon="Plus" @click="addClick"
						v-auth="'/plus/agent/user/add'">新增</el-button>
				</el-form-item>
			</el-form>
		</div>
		...
		<div class="product-content">
			<div class="table-wrap">
				<el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
					...
					<el-table-column prop="nickName" label="微信头像" width="90">
					...
					<el-table-column label="分销等级">
						<template #default="scope">
							<span v-if="!scope.row.grade">默认等级</span>
					...
					<el-table-column fixed="right" label="操作" width="260">
						<template #default="scope">
							<div>
								<el-button @click="saleClick(scope.row)" type="text" size="small"
									v-auth="'/plus/agent/order/index'">订单</el-button>
								<el-button @click="detailedClick(scope.row)" type="text" size="small"
									v-auth="'/plus/agent/cash/index'">提现</el-button>
								<el-button @click="openSubUser(scope.row)" type="text" size="small"
									v-auth="'/plus/agent/user/fans'">下级</el-button>
								<el-button @click="EditClick(scope.row)" type="text" size="small"
									v-auth="'/plus/agent/user/edit'">修改</el-button>
								<el-button @click="delClick(scope.row)" type="text" size="small"
									v-auth="'/plus/agent/user/delete'">删除</el-button>
							</div>
						</template>
					</el-table-column>
				</el-table>
