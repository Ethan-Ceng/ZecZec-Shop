  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="250px">
      ...
      <el-form-item label="支付宝 appid">
        <el-input v-model.trim="form.app_id" class="max-w460"></el-input>
      </el-form-item>
      <el-form-item label="支付宝公钥">
        <el-input type="textarea" :rows="4" v-model.trim="form.publicKey" class="max-w460"></el-input>
      </el-form-item>
      <el-form-item label="应用私钥">
        <el-input type="textarea" :rows="4" v-model.trim="form.privateKey" class="max-w460"></el-input>
      </el-form-item>
