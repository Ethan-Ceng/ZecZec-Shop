		...
		<el-form size="small" ref="form" :model="form" label-width="250px">
			...
			<template v-if="form.type == 1">
				<el-form-item label="公众号/h5对应的访问路径">
					<el-input v-model.trim="form.open_site" class="max-w460"></el-input>
					<div class="tips">如果未修改默认部署，则为https://域名/h5</div>
				</el-form-item>
			</template>
			<template v-if="form.type == 2">
				<el-form-item label="小程序原始id">
					<el-input v-model.trim="form.gh_id" class="max-w460"></el-input>
					<div class="tips">小程序管理后台，设置->账号信息->原始ID，以gh_ 开始</div>
				</el-form-item>
				<el-form-item label="webUrl">
					<el-input v-model.trim="form.web_url" class="max-w460"></el-input>
					<div class="tips">小程序链接失效访问的url</div>
				</el-form-item>
			</template>
			<template v-if="form.type == 3">
				<el-form-item label="下载地址">
					<el-input v-model.trim="form.down_url" class="max-w460"></el-input>
