<template>
	<div class="common-seach-wrap">
		<!--基础设置-->
		<BasicIndex v-show="activeName=='basic'"></BasicIndex>
		<!--分享设置-->
		<ShareIndex v-show="activeName=='share'"></ShareIndex>
		<!--升级设置-->
		<Update v-show="activeName=='update'"></Update>
	</div>
</template>
<script>
	import {
	...
	import BasicIndex from './part/basic.vue';
	import ShareIndex from './part/share.vue';
