	...
	<div class="user">
		...
		<div class="common-seach-wrap">
			<el-form size="small" :inline="true" :model="formInline" class="demo-form-inline">
				<el-form-item label="关键词"><el-input v-model="formInline.nick_name"
						placeholder="请输入昵称/手机号/ID"></el-input></el-form-item>
				<el-form-item label="会员等级">
					<el-select v-model="formInline.grade_id" placeholder="请选择" style="width: 205px;">
				...
				<div class="common-level-rail">
					<el-button size="small" type="primary" icon="Plus" v-auth="'/user/user/add'"
						@click="addClick">添加会员</el-button>
				</div>
			</el-form>
			<div class="mb16">
				<span>标签</span>
			...
			<div class="table-wrap">
				<el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
					...
					<el-table-column prop="referee" label="推荐人">
						<template #default="scope">
							<span v-if="scope.row.referee">
								<p class="red">ID：{{scope.row.referee.user_id}}</p>
								<p class="red">昵称：{{scope.row.referee.nickName}}</p>
							</span>
						</template>
					</el-table-column>
					...
					<el-table-column fixed="right" label="操作" width="240">
						<template #default="scope">
							<el-button @click="rechargeClick(scope.row)" type="text" size="small"
