  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="200px">
      ...
      <el-form-item label="所属门店">
        <el-select v-model="form.store_id" placeholder="请选择"  style="width: 460px;">
      ...
      <el-form-item label="店员姓名" prop="real_name" :rules="[{required: true,message: ' '}]">
        <el-input class="max-w460" v-model.trim="form.real_name" placeholder="请输入店员姓名"></el-input>
      </el-form-item>
      <el-form-item label="手机号" prop="mobile" :rules="[{required: true,message: ' '}]">
        <el-input class="max-w460" v-model.trim="form.mobile" placeholder="请输入手机号"></el-input>
      </el-form-item>
