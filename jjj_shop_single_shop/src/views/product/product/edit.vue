<template>
	<div class="product-add" v-loading="loading">
		<el-tabs v-model="activeName" type="card">
			...
			<el-tab-pane label="营销设置" name="buyset"></el-tab-pane>
  ...
  import isArray from "lodash/isArray"
	...
	export default {
		...
		methods: {
            ...
            self.form.model.faq_ids = self.form.model.faq_ids ? self.form.model.faq_ids.splice(',') : []
            ...
            params.faq_ids = isArray(self.form.model.faq_ids) ? self.form.model.faq_ids.join(',') : '';
						self.save_loading = true;
            console.log(params, this.product_id)
