		...
		<div class="product-content">
			<div class="table-wrap">
				<el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
					...
					<el-table-column prop="type_text" label="商品大分类"></el-table-column>
					<el-table-column label="商品起始时间" width="290">
						<template #default="scope">
							{{scope.row.active_time.join(' 至 ')}}
						</template>
					</el-table-column>
					<el-table-column prop="target_money" label="目标金额"></el-table-column>
					<el-table-column prop="total_money" label="计划内订单总金额"></el-table-column>
					...
					<el-table-column fixed="right" label="操作" width="210">
						<template #default="scope">
							...
							<el-button @click="copyClick(scope.row)" type="text" size="small"
								v-auth="'/product/product/copy'">复制</el-button>
