	...
	<div class="pr hh100 ">
		...
		<div class="scroll-ybox hh100" style="padding: 10px 0;box-sizing: border-box;">
			<div class="diy-phone-container">
				...
				<draggable class="wrapper" v-model="diyData.items" item-key="index"
					:options="{ animation: 120, filter: '.drag__nomove' }">
					<template #item="{ element, index }">
						<div class="diy-phone-item"
							:class="{ active: form.selectedIndex == index,pstatic:element.type == 'service' || element.type == 'videoLive' }">
							<div @click="onEditer(index)" v-if="element.type != 'service'&&element.type != 'videoLive'"
