    ...
    <div class="wrapper">
      <div class="diy-phone-item" v-for="(item, index) in diyData.items" :key="item.id">
        ...
        <template v-else-if="item.type == 'base'">
        	<Base :item="item" :index="index" :selectedIndex="form.selectedIndex"></Base>
        </template>
        <!--我的订单-->
...
.diy-phone-container::v-deep .phone-top {
  padding: 0 20px;
  border-radius: 18px 18px 0 0;
}
.diy-phone-container::v-deep .phone-top .status-bar {
  height: 20px;
  display: flex;
  justify-content: space-between;
}
.diy-phone-container::v-deep .phone-top .svg-icon {
  width: 20px;
  height: 20px;
  color: #333333;
}
.diy-phone-container::v-deep .phone-top .navigation {
  height: 44px;
  line-height: 44px;
  text-align: center;
  font-size: 18px;
}
.diy-phone-container::v-deep .diy-phone-item {
}
.diy-phone-container::v-deep .diy-phone-item > div {
  position: relative;
  border: 2px solid #f1f1f2;
  border:none;
}
.diy-phone-container::v-deep .diy-phone-item > div:hover,
.diy-phone-container::v-deep .diy-phone-item.active > div {
  border: 2px dashed #3a8ee6;
}
.diy-phone-container::v-deep .diy-phone-item .btn-edit-del {
  position: absolute;
  bottom: 0;
  right: 0;
  z-index: 1;
}
.diy-phone-container::v-deep .diy-phone-item .btn-edit-del > div {
  width: 32px;
  height: 16px;
  line-height: 16px;
...
.diy-phone-container::v-deep img {
  width: 100%;
}
</style>
