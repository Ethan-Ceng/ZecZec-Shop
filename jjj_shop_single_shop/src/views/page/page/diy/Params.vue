<template>
	...
	<div id="diy-editor" ref="diy-editor" class="diy-editor form-horizontal">
		...
		<Upload v-if="isupload" :isupload="isupload" :config="{ total: 3 }" @returnImgs="returnImgsFunc"
			:selectedIndex="diyData.items"></Upload>
		...
		<!--选择门店-->
		<StoreSelect :isstore="isstore" :excludeIds="excludeStoreIds" :islist="isstorelist"
			@closeDialog="closeStoreDialogFunc($event)"></StoreSelect>
	</div>
</template>
