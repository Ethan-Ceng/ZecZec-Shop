	...
	<div>
		...
		<el-form size="small" :model="curItem" label-width="100px">
			...
			<el-form-item label="标签：">
				<el-radio-group v-model="curItem.style.product_tag" size="medium">
					<el-radio-button :label="1">显示</el-radio-button>
					<el-radio-button :label="2">不显示</el-radio-button>
				</el-radio-group>
			</el-form-item>
			...
			<div class="form-item" v-if="curItem.style.product_tag">
				...
				<div class="flex-1 d-s-c" style="height: 36px;">
					<el-color-picker size="default" v-model="curItem.style.tagColor"></el-color-picker>
					<el-input class="ml10" v-model="curItem.style.tagColor" placeholder="透明" />
					<el-button style="margin-left: 10px;" @click.stop="$parent.onEditorResetColor(curItem.style, 'tagColor', '#999999')" type="primary" link>重置</el-button>
				</div>
			</div>
			<div class="form-item" v-if="curItem.style.product_tag">
				<div class="form-label">标签背景：</div>
				<div class="flex-1 d-s-c" style="height: 36px;">
					<el-color-picker size="default" v-model="curItem.style.bgTag"></el-color-picker>
					<el-input class="ml10" v-model="curItem.style.bgTag" placeholder="透明" />
					<el-button style="margin-left: 10px;" @click.stop="$parent.onEditorResetColor(curItem.style, 'bgTag', '#999999')" type="primary" link>重置</el-button>
				</div>
			</div>
			<!--组件样式-->
			<div class="form-chink"></div>
