	...
	<div>
		...
		<el-form size="small" :model="curItem" label-width="100px">
			...
			<el-form-item label="人数：">
				<el-radio-group v-model="curItem.style.product_numberbtn"  size="medium">
					<el-radio-button :label="1">显示</el-radio-button>
					<el-radio-button :label="2">不显示</el-radio-button>
				</el-radio-group>
			</el-form-item>
			...
			<template v-if="curItem.style.product_numberbtn == 1">
				<div class="form-chink"></div>
				<div class="f16 gray3 form-subtitle">人数</div>
				<div class="form-item">
					...
					<div class="flex-1 d-s-c" style="height: 36px;">
						...
						<view class="ml10"><el-color-picker size="default" v-model="curItem.style.title_color2"></el-color-picker></view>
...
export default {
	...
	created() {},
	methods: {
		ResetColor(titleColor1, titleColor2) {
			this.$parent.onEditorResetColor(this.curItem.style, titleColor1, '#ffffff');
			if (titleColor2) {
				this.$parent.onEditorResetColor(this.curItem.style, titleColor2, '#ffffff');
			}
		}
	}
};
