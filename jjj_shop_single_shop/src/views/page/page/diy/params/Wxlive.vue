<template>
	<div>
		...
		<el-form size="small" :model="curItem" label-width="100px">
			...
			<div class="f16 gray3 form-subtitle">组件设置</div>
			<!--显示数量-->
			<el-form-item label="显示数量："><el-input v-model="curItem.params.showNum" class="w-auto"></el-input></el-form-item>
			<div class="form-chink"></div>
			<div class="f16 gray3 form-subtitle">组件样式</div>
			<el-form-item label="背景图片：">
				<div class="diy-notice-icon"><img v-img-url="curItem.style.background_image" alt="" @click="$parent.onEditorSelectImage(curItem.style, 'background_image')" /></div>
