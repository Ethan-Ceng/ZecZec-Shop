<template>
  ...
  <div v-loading="loading" class="diy-container clearfix">
    ...
    <!--手机diy容器-->
    <div class="diy-phone"><Model v-if="!loading" ref="model" :form="form" :defaultData="defaultData" :diyData="diyData" :isDiy="true"></Model></div>

    <!--参数设置-->
    <div class="diy-info"><Params v-if="!loading" :form="form" :defaultData="defaultData" :diyData="diyData" :isDiy="true"></Params></div>
