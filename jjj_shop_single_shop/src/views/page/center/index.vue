<template>
	...
	<div class="d-b-s diy-preview">
		<!--手机diy容器-->
		<div class="diy-phone">
			<Model :diyType="'center'" v-if="!loading" ref="model" :form="form" :defaultData="defaultData"
				:diyData="diyData"></Model>
		</div>
					...
					<el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
						...
						<el-table-column fixed="right" label="操作" width="110">
							<template #default="scope">
								...
								<el-button @click="deleteClick(scope.row.page_id)" type="text" size="small"
									v-auth="'/page/center/delete'">
									删除
								</el-button>
							</template>
						</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getTableList() {
				...
				PageApi.centerList(Params, true)
					.then(data => {
						self.loading = false;
