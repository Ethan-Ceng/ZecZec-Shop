  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="150px">
      ...
      <el-form-item label="未支付订单">
        <el-input v-model.trim="form.close_days" type="number" class="max-w460 mr10"></el-input>
        天后自动关闭
        <div class="tips">
      ...
      <el-form-item label="已发货订单">
        <el-input v-model.trim="form.receive_days" type="number" class="max-w460 mr10"></el-input>
        天后自动确认收货
        <div class="tips">
      ...
      <el-form-item label="已完成订单">
        <el-input v-model.trim="form.refund_days" type="number" class="max-w460 mr10"></el-input>
        天内允许申请售后
        <div class="tips">
