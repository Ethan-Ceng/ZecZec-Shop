  ...
  <div class="product-add">
    ...
    <el-form ref="form" :model="form" label-width="250px">
      ...
      <el-form-item label="AppID 小程序ID">
        <el-input v-model.trim="form.wxapp_id"></el-input>
      </el-form-item>
      <el-form-item label="AppSecret 小程序密钥">
        <el-input v-model.trim="form.wxapp_secret" type="password"></el-input>
      </el-form-item>
      ...
      <el-form-item label="微信支付商户号 MCHID">
        <el-input v-model.trim="form.mchid"></el-input>
      </el-form-item>
      ...
      <el-form-item label="apiclient_cert.pem">
        <el-input type="textarea" :rows="4" placeholder="使用文本编辑器打开apiclient_cert.pem文件，将文件的全部内容复制进来" v-model.trim="form.cert_pem"></el-input>
        <div class="tips">使用文本编辑器打开apiclient_key.pem文件，将文件的全部内容复制进来</div>
      </el-form-item>
      <el-form-item label="apiclient_key.pem">
        <el-input type="textarea" :rows="4" placeholder="使用文本编辑器打开apiclient_cert.pem文件，将文件的全部内容复制进来" v-model.trim="form.key_pem"></el-input>
        <div class="tips">使用文本编辑器打开apiclient_key.pem文件，将文件的全部内容复制进来</div>
      </el-form-item>
