      ...
      <div class="table-wrap">
        ...
        <div>
          <el-form-item label="模板id：">
            <el-input size="small" class="max-w460" v-model.trim="template_id" placeholder="请填写申请的公众号模板消息id"></el-input>
          </el-form-item>
        </div>
        <el-table border ref="fieldTable" :data="fieldList" @selection-change="handleSelectionChange" v-loading="loading">
          ...
          <el-table-column label="模板变量名">
            <template #default="scope">
              <el-input size="small" prop="field_new_ename" v-model.trim="scope.row.field_new_ename"></el-input>
            </template>
          </el-table-column>
          <el-table-column label="模板内容">
            <template #default="scope">
              <el-input size="small" prop="filed_new_value" :disabled="scope.row.is_var === 1" v-model.trim="scope.row.filed_new_value"></el-input>
            </template>
          </el-table-column>
        </el-table>
      </div>
