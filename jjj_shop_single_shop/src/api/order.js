...
let OrderApi = {
  ...
  /*电子面单取消*/
  labelCancel(data, errorback) {
    return request._post('/shop/order.order/labelCancel', data, errorback);
  },
  /*电子面单取消*/
  printOld(data, errorback) {
    return request._post('/shop/order.order/printRepeate', data, errorback);
  },
  /*查看物流*/
  orderExpress(data, errorback) {
