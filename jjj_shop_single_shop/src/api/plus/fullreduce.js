...
let FullreduceApi = {
    ...
    /*列表*/
    product(data, errorback) {
        return request._post('/shop/plus.fullreduce/product', data, errorback);
    },
    editProduct(data, errorback) {
        return request._post('/shop/plus.fullreduce/editProduct', data, errorback);
    },
}
