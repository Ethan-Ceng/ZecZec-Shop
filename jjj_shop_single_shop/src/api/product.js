...
let ProductApi = {
	...
	CatSet(data, errorback) {
	    return request._post('/shop/product.category/set', data, errorback);
	},
    /*产品列表*/
    ...
    /*商品Faq列表*/
    getFaqList(data, errorback) {
        return request._get('/shop/product.Faq/index', data, errorback);
    },
    /*获取Faq详情*/
    getFaq(data, errorback) {
        return request._post('/shop/product.Faq/detail', data, errorback);
    },
    addFaq(data, errorback) {
        return request._post('/shop/product.Faq/add', data, errorback);
    },
    /*获取Faq详情*/
    editFaq(data, errorback) {
        return request._post('/shop/product.Faq/edit', data, errorback);
    },
    /*Faq评论*/
    delFaq(data, errorback) {
        return request._post('/shop/product.Faq/delete', data, errorback);
    },

    /*获取Message*/
    getMessageList(data, errorback) {
        return request._post('/shop/product.Message/lists', data, errorback);
    },
    sendMessage(data, errorback) {
        return request._post('/shop/product.Message/sendMessage', data, errorback);
    },
    /*获取消息列表*/
    getMessageBoxDetail(data, errorback) {
        return request._get('/shop/product.Message/getMessageBoxDetail', data, errorback);
    },
}
