...
let FileApi = {
	...
	/*移动文件*/
	SystemPictureList(formData, errorback) {
	    return request._post('/shop/file.image/list', formData, errorback);
	},
	/*移动文件*/
	PictureIndex(formData, errorback) {
	    return request._post('/shop/file.image/index', formData, errorback);
	},
