...
import {CaretBottom, Message, Search, Menu} from "@element-plus/icons-vue";
...
<template>
  <div class="text-sm flex items-center justify-between">
    ...
    <div class="sm:hidden inline-block order-3">
      <el-dropdown trigger="click">
        <el-icon class="text-lg align-middle font-bold" :size="22"><Menu/></el-icon>
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item>
              <router-link
