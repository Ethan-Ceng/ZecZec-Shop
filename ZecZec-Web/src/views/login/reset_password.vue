...
<template>
  <div class="login-wrapper">
    ...
    <div class="sm:max-w-xl flex items-center justify-center bg-white px-8 md:px-16 w-full sm:w-4/5">
      <div class="max-w-sm w-full py-16">
        ...
        <h4 class="mb-8">
          回到
          <router-link class="text-blue-600 font-bold underline" to="/login">登入</router-link>
          或
          <router-link class="text-blue-600 font-bold underline" to="/register">註冊帳號</router-link>
          。
        </h4>
        <el-form
          ref="formStateRef"
        ...
        >
          ...
          <div class="mb-4">
            <el-form-item label="新密碼（至少六碼）" prop="password">
              <el-input type="password" v-model="formState.password" show-password/>
            </el-form-item>
