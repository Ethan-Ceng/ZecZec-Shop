            ...
            <div class="flex lg:-mx-4">
                ...
                >
                    ...
                    >
                        ...
                        />
                        <div
                            class="flex flex-col flex-1 h-full justify-between px-3"
                        >
                            <h3
                                class="my-4 font-bold leading-relaxed line-clamp-3"
                            >
                            ...
                            <div>
                                <div class="flex items-center pb-2 space-x-2">
                                    <div class="relative flex-1">
                                        <div
                                            class="border-4 absolute w-full rounded border-zec-green bg-zec-green"
                                            style="width: 100%"
                                        ></div>
                                        <div
                                            class="border-4 border-gray-200 bg-gray-200 rounded"
                                        ></div>
                                    </div>
                                    <h4
                                        class="text-xs flex-initial text-zec-green"
                                    >
                                        {{
                                            (
                                                get(item, "total_money", 1) /
                                                get(item, "target_money", 1)
                                            ).toFixed(1)
                                        }}%
                                    </h4>
                                </div>
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <h4
                                        class="text-sm font-semibold flex items-center text-zec-green"
                                    >
                                        <svg-icon
                                            class="text-sm text-gray-500 leading-none align-middle mr-px"
                                            name="user"
                                        />
                                        <span
                                            class="text-sm inline-block mr-px"
                                            >{{
                                    ...
                                    <span
                                        class="inline-block font-bold text-xs text-white px-2 py-1 rounded border-zec-green bg-zec-green"
                                        >集資成功</span
                                    >
                                </div>
                            </div>
