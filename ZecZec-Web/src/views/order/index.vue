            ...
            <div class="w-full flex">
                ...
                <div class="py-2 lg:px-2 px-4 flex-1">
                    ...
                    <span class="font-bold"
                        >$ {{ get(productDetail, "total_money", "") }}</span
                    >
                    <span class="text-xs text-neutral-600"
                        >/ 目標 $
                        {{ get(productDetail, "target_money", "") }}</span
                    >
                    <p
    ...
    <div class="container my-8" v-loading="loading">
        <div class="lg:-mx-4 flex">
            <div class="w-full px-4 mb-8">
                <div
                    class="text-center text-xs rounded bg-zinc-100 p-2 font-bold tracking-widest hidden xs:block"
                >
                    <el-icon>
                        <ArrowLeftBold />
                    </el-icon>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <!--
                                <p
                                    class="w-full text-gray-500 font-normal text-xs"
                                >
                                    預定售價
