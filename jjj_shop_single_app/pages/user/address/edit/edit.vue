			...
			<view class="bg-white p-0-30 f30">
				...
				<view class="d-s-c border-b" @click="showMulLinkageThreePicker">
					...
					<view class="input-box flex-1">
						<input class="ml20 f32 flex-1 p-30-0" type="text" placeholder-class="grary9" placeholder=""
							v-model="selectCity" disabled="true" style="pointer-events: none" />
					</view>
				</view>
				<view class="d-s-c border-b">
					<text class="key-name">详细地址</text>
					<textarea class="ml20 flex-1 f32 p-30-0 lh150" name="detail" placeholder-class="grary9"
						:auto-height="true" v-model="address.detail" placeholder="请输入街道小区楼牌号等"></textarea>
				</view>
				<view class="d-b-c">
