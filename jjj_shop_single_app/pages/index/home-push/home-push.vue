			...
			<view class="home-push" :class="type == 1 || type == 3 ? 'home-push-bg' : ''">
				...
				<template v-if="type == 1">
					<view class="image-text">
						...
						<view class="btns">
							<button class="button" type="primary" @click="jumpPage(form.link.url)">{{ form.des }}</button>
						</view>
					</view>
				</template>
				<!--纯图-->
				...
				<template v-if="type == 3">
					<view class="cuopon">
						<view class="cuopon-title d-c-c" v-if="form.file_path!=null&&form.file_path!=''">
							<image class="image" :src="form.file_path" mode="aspectFill"></image>
						</view>
						<view class="list">
						...
						<view class="btns"><button class="button" type="primary" @click="getCoupon()">立即领取</button></view>
					</view>
				</template>
			</view>
