	...
	<view :data-theme="theme()" :class="theme() || ''">
		<view class="top-box">
			...
			<view class="inner-tab">
				<view :class="type_active == 0 ? 'item active' : 'item'" @click="tabTypeFunc(0)"><view class="box">综合</view></view>
				<view :class="type_active == 1 ? 'item active' : 'item'" @click="tabTypeFunc(1)"><view class="box">销量</view></view>
				<view :class="type_active == 2 ? 'item active' : 'item'" @click="tabTypeFunc(2)">
					<view class="box">
						<text>价格</text>
						<view class="arrows">
							<view :class="price_top && type_active == 2 ? 'arrow active' : 'arrow'"><text class="icon iconfont icon-sanjiao2"></text></view>
							<view :class="!price_top && type_active == 2 ? 'arrow active' : 'arrow'"><text class="icon iconfont icon-sanjiao1"></text></view>
						</view>
					</view>
				</view>
				<view class="item">
					<view class="box" style="height: 100%;">
						<image style="width: 36rpx;height: 36rpx;" @click="select_type()" :src="isLieBiao == true ? '/static/liebiao.png' : '/static/tubiao.png'"></image>
					</view>
				</view>
			</view>
		</view>
